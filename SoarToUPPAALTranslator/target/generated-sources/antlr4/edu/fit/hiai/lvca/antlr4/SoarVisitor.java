...
public interface SoarVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SoarParser#value_pref_binary_value}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitValue_pref_binary_value(SoarParser.Value_pref_binary_valueContext ctx);
	/**
	 * Visit a parse tree produced by {@link SoarParser#value_pref_clause}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitValue_pref_clause(SoarParser.Value_pref_clauseContext ctx);
	/**
