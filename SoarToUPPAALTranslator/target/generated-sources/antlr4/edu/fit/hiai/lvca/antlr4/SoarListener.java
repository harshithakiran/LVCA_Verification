...
public interface SoarListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SoarParser#value_pref_binary_value}.
	 * @param ctx the parse tree
	 */
	void enterValue_pref_binary_value(SoarParser.Value_pref_binary_valueContext ctx);
	/**
	 * Exit a parse tree produced by {@link SoarParser#value_pref_binary_value}.
	 * @param ctx the parse tree
	 */
	void exitValue_pref_binary_value(SoarParser.Value_pref_binary_valueContext ctx);
	/**
	 * Enter a parse tree produced by {@link SoarParser#value_pref_clause}.
	 * @param ctx the parse tree
	 */
	void enterValue_pref_clause(SoarParser.Value_pref_clauseContext ctx);
	/**
	 * Exit a parse tree produced by {@link SoarParser#value_pref_clause}.
	 * @param ctx the parse tree
	 */
	void exitValue_pref_clause(SoarParser.Value_pref_clauseContext ctx);
	/**
